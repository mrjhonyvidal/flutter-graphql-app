...
class GraphQLCNDVClient{
  ...
  static final HttpLink httpLink = HttpLink('https://blooming-wildwood-50755.herokuapp.com');
  ...
  static ValueNotifier<GraphQLClient> inititializeTokenAuthenticatedClient(String token){
